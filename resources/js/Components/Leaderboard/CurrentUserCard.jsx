export default function CurrentUserCard({ user }) {
    ...
    return (
        <div className="flex items-center gap-4 bg-highlight rounded-lg p-5 shadow-md border-2 border-secondary">
                <div className="font-quicksand font-bold text-tertiary text-xl w-12 text-center">
                    {user.rank}
                </div>
                ...
                <div className="flex-1 min-w-0">
                    <p className="font-quicksand font-semibold text-tertiary text-base truncate">
                        {user.name}
                    </p>
                </div>
